                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <?php
                                                        // if($priv_add == 1)
                                                        // {
                                                            echo '<a href="'.base_url().'Produksi/Perhitungan-Kebutuhan-Bahan/Form">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="default-table">
                                        <thead>
                                            <tr>
                                                <th> No </th>
                                                <th> Cabang </th>
                                                <th> No Perhitungan Kebutuhan </th>
                                                <th> Jenis </th>
                                                <th> No Refrensi </th>
                                                <th> Tanggal Perhitungan Kebutuhan </th>
                                                <th> Status </th>
                                                <th> Action </th>
                                            </tr>
                                        </thead>
        ...
        <script type="text/javascript">
            ...
            function searchData() { 
                $('#default-table').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                      url: '<?php echo base_url();?>Produksi/Perhitungan-Kebutuhan-Bahan/loadData/'
                    },
                    "columns": [
                      {"name": "no","orderable": false,"searchable": false,  "className": "text-center", "width": "5%"},
                      {"name": "cabang_nama"},
                      {"name": "perhitungan_kebutuhan_nomor"},
                      {"name": "perhitungan_kebutuhan_jenis"},
                      {"name": "jadwal_produksi_nomor"},
                      {"name": "perhitungan_kebutuhan_tanggal"},
                      {"name": "perhitungan_kebutuhan_status_nama"},
