                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <form action="#" id="formAdd" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <input type="hidden" id="url" value="Produksi/Perhitungan-Kebutuhan-Bahan/postData/">
                                        <input type="hidden" id="url_data" value="Produksi/Perhitungan-Kebutuhan-Bahan">
                                        ...
                                        <div class="form-group">
                                            <div id="produksi" hidden="false">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <select class="form-control" id="t_jadwal_produksi_id" name="t_jadwal_produksi_id" aria-required="true" aria-describedby="select-error" multiple="multiple" onchange="addJadwal()" required>
                                                        </select>
                                                    </div>
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-4 col-md-8 text-right">
                                                ...
                                                <a href="<?php echo base_url();?>Produksi/Perhitungan-Kebutuhan-Bahan">
        ...
        <script type="text/javascript">
                            ...
                            $("#default-table"+idx+" tbody").append('\
                                <tr id="detail'+idx+'-'+jmlBahan+'">\
                                    ...
                                    <td id="td3'+idx+'-'+jmlBahan+'">\
                                        <input type="text" class="form-control decimal" id="perhitungan_kebutuhandet_ukuran'+idTabel+''+jmlBahan+'" name="perhitungan_kebutuhandet_ukuran'+idTabel+'[]" value="0" required/>\
                                    </td>\
                                    <td id="td4'+idx+'-'+jmlBahan+'">\
                                        <input type="text" class="form-control decimal" id="perhitungan_kebutuhandet_lebar'+idTabel+''+jmlBahan+'" name="perhitungan_kebutuhandet_lebar'+idTabel+'[]" value="0" required/>\
                                    </td>\
                                    <td id="td5'+idx+'-'+jmlBahan+'">\
                                        <input type="text" class="form-control decimal" id="perhitungan_kebutuhandet_slitingan'+idTabel+''+jmlBahan+'" name="perhitungan_kebutuhandet_slitingan'+idTabel+'[]" value="0" required/>\
                                    </td>\
                                    <td id="td6'+idx+'-'+jmlBahan+'">\
                                        <textarea class="form-control" rows="3" name="perhitungan_kebutuhandet_keterangan'+idTabel+'[]" id="perhitungan_kebutuhandet_slitingan'+idTabel+''+jmlBahan+'"></textarea>\
                                    </td>\
                                </tr>\
                            ');
                            jmlBahan++;
                 ...
                 $("#default-value").append('\
                    ...
                    <div class="form-group">\
                                ...
                                <div class="col-md-3">\
                                    <div class="input-icon right">\
                                        <i class="fa"></i>\
                                        <input type="text" class="form-control num" name="jadwal_produksi_qty[]" value="0" id="jadwal_produksi_qty'+itemOption+'" onchange="total('+itemOption+')" required />\
                                     </div>\
                                </div>\
                                <label class="control-label col-md-3">Berat\
                                    <span class="required"> * </span>\
                                ...
                                <div class="col-md-3">\
                                    <div class="input-icon right">\
                                        <i class="fa"></i>\
                                        <input type="text" class="form-control num" name="perhitungan_kebutuhandet_berat[]" value="0" id="perhitungan_kebutuhandet_berat'+itemOption+'" onchange="total('+itemOption+')" required /> </div>\
                                </div>\
                            </div>\
                            <div class="form-group">\
                                <label class="control-label col-md-3">Total\
                                ...
                                <div class="col-md-3">\
                                    <div class="input-icon right">\
                                        <i class="fa"></i>\
                                        <input type="text" class="form-control num" name="perhitungan_kebutuhandet_total[]" value="0" id="perhitungan_kebutuhandet_total'+itemOption+'" required />\
                                     </div>\
                                </div>\
                            </div>\
                            <div class="form-group">\
                                ...
                                <div class="col-md-1">\
                                    <button type="button" id="btnAddBahan" class="btn sbold dark" onclick="addBahan2('+itemOption+')">\
                                    <i class="icon-plus"></i></button>\
                                </div>\
                            </div>\
                            <div class="form-group">\
            ...
            function addBahan2(itemOption, id=null) {
                if(id == null)
                {
                    id = document.getElementById('m_barang_id'+itemOption+'')[0].value;
                }
                if (id.length > 0) {
