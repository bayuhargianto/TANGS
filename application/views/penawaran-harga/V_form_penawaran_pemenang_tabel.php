                ...
                if ($supplier) {
                    ...
                    foreach ($supplier->result() as $row) {
                        echo '
                            ...
                            <th colspan="2" style="vertical-align: middle; text-align: center;">
                                <input type="hidden" name="t_penawaran_supplier_id_pemenang[]" value="'.$row->penawaran_supplier_id.'">
                    ...
                    if ($supplier) {
                        ...
                        foreach ($supplier->result() as $row2) {
                            ...
                            echo '
                                ...
                                <td>
                                    <input type="text" class="form-control" name="penawaran_harga_nominal[]" id="penawaran_harga_nominal'.$no.''.$no2.'"value="'.$diskon_perbarang.'" readonly>
                                </td>
                                <td>
        ...
        <tr>
            ...
            <?php
                if ($supplier) {
                    $no = 1;
                    foreach ($supplier->result() as $row) {
                        if ($row->penawaran_supplier_pemenang == 1) {
                            $checked = 'checked';
                        } else {
                            $checked = '';
                        }
                        echo '
                            <th colspan="4">
                                ...
                                <label class="mt-checkbox"> Pilih Pemenang
                                    <input type="checkbox" value="1" id="penawaran_supplier_pemenang2'.$no.'" onclick="checkPemenang('.$no.');" '.$checked.' />
                                    <span></span>
                                </label>
                                <textarea class="form-control" rows="3" name="penawaran_supplier_alasan[]">'.$row->penawaran_supplier_alasan.'</textarea>
                            </th>
                        ';
                        $no++;
                    }
