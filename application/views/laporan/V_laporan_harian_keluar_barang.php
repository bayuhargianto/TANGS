            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="Laporan-Harian-Keluar-Barang/Print-LHKB" id="formDataLHKB" class="form-horizontal" method="post">
...
<script type="text/javascript">
            ...
            function searchDataKartuStok() { 
                $('#default-table-kartu-stok').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                      url: '<?php echo base_url();?>Laporan/Laporan-Harian-Keluar-Barang/loadDataKartuStokKeluar/',
