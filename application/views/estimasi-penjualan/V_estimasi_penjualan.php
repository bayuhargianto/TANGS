                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <?php
                                                        // if($priv_add == 1)
                                                        // {
                                                            echo '<a href="'.base_url().'Penjualan/Estimasi-Penjualan/Form">
        ...
        <script type="text/javascript">
            ...
            function searchData() { 
                $('#default-table').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                      url: '<?php echo base_url();?>Penjualan/Estimasi-Penjualan/loadData/'
                    },
                    "columns": [
                      {"name": "no","orderable": false,"searchable": false,  "className": "text-center", "width": "5%"},
                      {"name": "estimasi_penjualan_nomor"},
                      {"name": "estimasi_penjualan_periode"},
                      {"name": "estimasi_penjualan_status_nama"},
                      {"name": "action"}
                    ],
