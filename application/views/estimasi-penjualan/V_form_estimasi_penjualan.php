                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <form action="#" id="formAdd" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <input type="hidden" id="url" value="Penjualan/Estimasi-Penjualan/postData/">
                                        <input type="hidden" id="url_data" value="Penjualan/Estimasi-Penjualan">
                                        <input type="hidden" name="estimasi_penjualan_status" value="1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                        <input name="estimasi_penjualan_periode" type="text"  value="<?php echo date('01/m/Y');?> - <?php echo date('t/m/Y');?>" class="form-control datepicker-range" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-4 col-md-8 text-right">
                                                ...
                                                <a href="<?php echo base_url();?>Penjualan/Estimasi-Penjualan">
                        ...
                        $("#default-table tbody").append('\
                            <tr id="detail'+(itemBarang)+'">\
                                ...
                                <td id="td1'+(itemBarang)+'">\
                                    <input type="hidden" name="estimasi_penjualan_barang_id[]" value="'+data.val[i].kode+'"/>\
                                    '+data.val[i].barang_nama+'\
                                </td>\
                                <td id="td2'+(itemBarang)+'">\
                                    <input type="text" class="form-control" id="estimasi_penjualandet_jumlah'+(itemBarang)+'" name="estimasi_penjualandet_jumlah[]" value="0" required />\
                                </td>\
                                <td id="td3'+(itemBarang)+'">\
                                    '+data.val[i].m_satuan_id.val2[i].text+'\
                                </td>\
                                <td id="td4'+(itemBarang)+'">\
                                    <button type="button" id="removeBtn'+(itemBarang)+'" class="btn red-thunderbird" onclick="removeBarang('+(itemBarang)+')">\
