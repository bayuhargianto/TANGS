<!-- BEGIN FORM-->
    <form action="#" id="formAdd" class="form-horizontal" method="post">
        <div class="form-body">
            ...
            <input type="hidden" id="url" value="Master-Data/Master-Kategori/postData/">
            <div class="form-group" hidden="true">
                <label class="control-label col-md-4">Kode Category 2 (Auto)
            ...
            <div class="form-group">
                <label class="control-label col-md-4">Status Category 2
                    <span class="required"> * </span>
                </label>
                <div class="col-md-8">
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <select class="form-control select2" name="category_2_status_aktif" aria-required="true" aria-describedby="select-error" required>
