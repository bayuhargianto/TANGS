                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <?php
                                                        if($priv_add == 1)
                                                        {
                                                            echo '<a href="'.base_url().'Marketing/Klaim-Retur-Penjualan/Form">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="default-table">
                                        <thead>
                                            <tr>
                                                <th> No </th>
                                                <th> Cabang </th>
                                                <th> No Klaim/Retur </th>
                                                <th> Tanggal Klaim/Retur </th>
                                                <th> Status </th>
                                                <th> Action </th>
                                            </tr>
                                        </thead>
        ...
        <script type="text/javascript">
            ...
            function searchData() { 
                $('#default-table').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                      url: '<?php echo base_url();?>Marketing/Klaim-Retur-Penjualan/loadData/'
                    },
                    "columns": [
                      {"name": "no","orderable": false,"searchable": false,  "className": "text-center", "width": "5%"},
                      {"name": "cabang_nama"},
                      {"name": "retur_penjualan_nomor"},
                      {"name": "retur_penjualan_tanggal"},
                      {"name": "retur_penjualan_status_nama"},
