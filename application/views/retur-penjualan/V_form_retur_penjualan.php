                                        ...
                                        <div class="form-wizard">
                                            <div class="form-body">
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <input type="hidden" id="url" value="Penjualan/Klaim-Retur-Penjualan/postData/">
                                                    <input type="hidden" id="url_data" value="Penjualan/Klaim-Retur-Penjualan">
                                            ...
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div class="col-md-offset-4 col-md-8 text-right">
                                                        ...
                                                        <a href="<?php echo base_url();?>Penjualan/Klaim-Retur-Penjualan">
