                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <?php
                                                        if($priv_add == 1)
                                                        {
                                                            echo '<a href="'.base_url().'Penjualan/Faktur-Penjualan/Form">
        ...
        <script type="text/javascript">
            ...
            function searchData() { 
                $('#default-table').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                      url: '<?php echo base_url();?>Penjualan/Faktur-Penjualan/loadData/'
                    },
                    "columns": [
                      {"name": "no","orderable": false,"searchable": false,  "className": "text-center", "width": "5%"},
                      {"name": "cabang_nama"},
                      {"name": "faktur_penjualan_nomor"},
                      {"name": "so_customer_nomor"},
                      {"name": "faktur_penjualan_tanggal"},
