                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <?php
                                                        if($priv_add == 1)
                                                        {
                                                            echo '<a href="'.base_url().'Produksi/Bukti-Keluar-Barang/Form">
        ...
        <script type="text/javascript">
            ...
            function searchData() { 
                $('#default-table').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                      url: '<?php echo base_url();?>Produksi/Bukti-Keluar-Barang/loadData/'
                    },
                    "columns": [
                      {"name": "no","orderable": false,"searchable": false,  "className": "text-center", "width": "5%"},
                      {"name": "cabang_nama"},
                      {"name": "keluar_barang_nomor"},
                      {"name": "keluar_barang_jenis_nama"},
                      {"name": "keluar_barang_tanggal"},
                      {"name": "departemen_nama"},
                      {"name": "keluar_barang_status_nama"},
