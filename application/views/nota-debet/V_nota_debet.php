                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <?php
                                                        // if($priv_add == 1)
                                                        // {
                                                            echo '<a href="'.base_url().'Pembelian/Nota-Debet/Form">
        ...
        <script type="text/javascript">
            ...
            function searchData() { 
                $('#default-table').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                      url: '<?php echo base_url();?>Pembelian/Nota-Debet/loadData/'
                    },
                    "columns": [
                      {"name": "no","orderable": false,"searchable": false,  "className": "text-center", "width": "5%"},
                      {"name": "cabang_nama"},
                      {"name": "nota_debet_nomor"},
                      {"name": "retur_pembelian_nomor"},
                      {"name": "partner_nama"},
                      {"name": "nota_debet_tanggal"},
                      {"name": "nota_debet_status_nama"},
