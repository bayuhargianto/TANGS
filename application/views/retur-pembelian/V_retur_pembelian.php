                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <?php
                                                        // if($priv_add == 1)
                                                        // {
                                                            echo '<a href="'.base_url().'Gudang/Retur-Pembelian/Form">
        ...
        <script type="text/javascript">
            ...
            function searchData() { 
                $('#default-table').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                      url: '<?php echo base_url();?>Gudang/Retur-Pembelian/loadData/'
                    },
                    "columns": [
                      ...
                      {"name": "retur_pembelian_tanggal"},
                      {"name": "retur_pembelian_status_nama"},
