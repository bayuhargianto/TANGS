                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade" id="tab-kartu-stok">
                                          <?php $this->load->view('stok-gudang/V_tab_kartu_stok2');?>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script type="text/javascript">
            ...
            function searchDataStok() { 
                $('#default-table-stok').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                      url: '<?php echo base_url();?>Accounting/Stok-Gudang/loadDataStok/'
                    },
                    "columns": [
            ...
            function searchDataKartuStok() { 
                $('#default-table-kartu-stok').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                      url: '<?php echo base_url();?>Accounting/Stok-Gudang/loadDataKartuStok/',
