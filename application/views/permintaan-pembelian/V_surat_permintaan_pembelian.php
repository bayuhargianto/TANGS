                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <?php
                                                        if($priv_add == 1)
                                                        {
                                                            echo '<a href="'.base_url().'Gudang/Surat-Permintaan-Pembelian/Form">
        ...
        <script type="text/javascript">
            ...
            function searchData() { 
                $('#default-table').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                      url: '<?php echo base_url();?>Gudang/Surat-Permintaan-Pembelian/loadData/'
                    },
                    "columns": [
                                ...
                                $.ajax({
                                  ...
                                  success:function(data){
                                    if(data.status=='200'){
                                        ...
                                        $.ajax({
                                          url: '<?php echo base_url();?>Gudang/Surat-Permintaan-Pembelian/deleteData/',
                                          data : { id : id },
                                          type: 'POST',
                                          dataType: 'json',
                                          success: function (data) {
