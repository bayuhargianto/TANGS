                                            ...
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                                    ...
                                                    <div class="input-group date datepicker" data-date-format="dd/mm/yyyy" data-date-start-date="+0d">
                                                        <input type="text" class="form-control" name="permintaan_pembelian_tanggal_dibutuhkan" required>
                                                        <span class="input-group-addon" style="">
                                                            <span class="icon-calendar"></span>
                                                        </span>
                                                    </div>
                    ...
                    for(var i = 0; i < data.val2.length; i++){
                        $("#default-table2 tbody").append('\
                            <tr>\
                                ...
                                <td>\
                                    <input type="text" class="form-control num2" name="permintaan_pembeliandet_qty[]" value="'+data.val2[i].permintaan_pembeliandet_qty+'" required '+disabled_inp+' />\
                                </td>\
                                <td id="satuan'+(i+1)+'">\
                                    '+data.val2[i].satuan_nama+'\
                                </td>\
                        ...
                        ');
                        $("#m_barang_iddet"+(i+1)).append('<option value="'+data.val2[i].m_barang_id+'" selected>'+data.val2[i].barang_nama+' ('+data.val2[i].jenis_barang_nama+')</option>');
                        $("#m_barang_iddet"+(i+1)).select2();
                        selectList_barangUraian("#m_barang_iddet"+(i+1));
                        $('.num2').number( true, 2, '.', ',' );
                    }
                  }
                });
