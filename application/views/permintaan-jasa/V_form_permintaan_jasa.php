                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <form action="#" id="formAdd" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <input type="hidden" id="url" value="Produksi/Permintaan-Jasa/postData/">
                                        <input type="hidden" id="url_data" value="Produksi/Permintaan-Jasa">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Untuk Departemen 
                                                <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                                    ...
                                                    <div class="input-group date datepicker" data-date-format="dd/mm/yyyy" data-date-start-date="+0d">
                                                        <input type="text" class="form-control" name="permintaan_jasa_tanggal_dibutuhkan" required>
                                                        <span class="input-group-addon" style="">
                                                            <span class="icon-calendar"></span>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-md-8">
                                                <div class="mt-radio-inline">
                                                    ...
                                                    <label class="mt-radio"> Barang
                                                        <input type="radio" value="1" name="permintaan_pembelian_type" id="permintaan_pembelian_type1" required />
                                                        <span></span>
                                                    </label>
                                                    <label class="mt-radio"> Jasa
                                                        <input type="radio" value="2" name="permintaan_pembelian_type" id="permintaan_pembelian_type2" />
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <textarea class="form-control" rows="3" name="permintaan_pembelian_alasan" required></textarea> </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <textarea class="form-control" rows="3" name="permintaan_pembelian_catatan" required></textarea> </div>
                                            </div>
                                        </div> -->
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Nama Jasa
                                                <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-7">
                                                <div class="input-icon right">
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-4 col-md-8 text-right">
                                                ...
                                                <a href="<?php echo base_url();?>Produksi/Permintaan-Jasa">
        ...
        <script type="text/javascript">
                        ...
                        $("#default-table2 tbody").append('\
                            <tr>\
                                ...
                                <td>\
                                    ...
                                    <input type="hidden" name="permintaan_jasadet_id[]" value=""/>\
                                ...
                                <td>\
                                    <textarea name="permintaan_jasadet_keterangan[]" required></textarea>\
                                </td>\
                            </tr>\
                        ');
                    }
            ...
            function editData(id) {
                $.ajax({
                  type : "GET",
                  url  : '<?php echo base_url();?>Produksi/Permintaan-Jasa/loadDataWhere/',
                  data : "id="+id,
                  dataType : "json",
                  success:function(data){
                    for(var i=0; i<data.val.length;i++){
                    ...
                    for(var i = 0; i < data.val2.length; i++){
                        $("#default-table2 tbody").append('\
                            <tr>\
                                ...
                                <td>\
                                    <textarea name="permintaan_jasadet_keterangan[]" required readonly>'+data.val2[i].permintaan_jasadet_keterangan+'</textarea>\
                                </td>\
                            </tr>\
                        ');
                    }
