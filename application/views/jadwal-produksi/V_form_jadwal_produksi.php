                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <form action="#" id="formAdd" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <input type="hidden" id="url" value="Produksi/Jadwal-Produksi/postData/">
                                        <input type="hidden" id="url_data" value="Produksi/Jadwal-Produksi">
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-4 col-md-8 text-right">
                                                ...
                                                <a href="<?php echo base_url();?>Produksi/Jadwal-Produksi">
        ...
        <script type="text/javascript">
            ...
            function addEstimasi() {
                ...
                if (id.length > 0) {
                    if(document.getElementById('estimasi_penjualan').checked)
                    {
                        getDetailEstimasi(id);
                    }
                    else if(document.getElementById('sales_order').checked)
                    {
                        getDetailSO(id);
                    }
                }
            ...
            function getEstimasi(radioElemen)
            {
                ...
                else if(id == 'sales_order')
                {
                    $("#t_estimasi_penjualan_id").removeAttr('disabled');
                    selectList_SOCustomer("#t_estimasi_penjualan_id");
                }
            }
            ...
            function getBarang(elemen)
            {
                ...
                $.ajax({
                  ...
                  success:function(data){
                    for( var i = 0; i < data.val.length; i++)
                    {
                        noSeri.push(data.val[i].stok_gudang_no_seri);
                    }
            ...
            function removeItemOption(itemSeq) {
                ...
                for (var i = 1; i <= itemBarang; i++) {
                  if (i >= itemSeq && i < itemBarang) {
                    ...
                    var inp2 = document.getElementById('jadwal_produksi_awaldet_qty'+(i+1)).value;
                    var inp3 = document.getElementById('jadwal_produksi_awaldet_satuan'+(i+1)).value;
                    var inp4 = document.getElementById('kode_barang'+(i+1)).value;
                    var sel2 = document.getElementById('jadwal_produksi_awaldet_no_seri'+(i+1));
                    var inp5 = sel2.options[sel2.selectedIndex].value;
                    ...
                    $('#jadwal_produksi_awaldet_no_seri'+i).select2('destroy');
                    $('#jadwal_produksi_awaldet_no_seri'+i).empty();
                    $('#jadwal_produksi_awaldet_no_seri'+i).append('<option value="'+inp5+'" selected>'+text2+'</option>');
                    $('#jadwal_produksi_awaldet_no_seri'+i).select2();
                    selectList_barang2("#m_barang_id_"+i);
                    document.getElementById('jadwal_produksi_awaldet_qty'+i).value = inp2;
                    document.getElementById('jadwal_produksi_awaldet_satuan'+i).value = inp3;
            ...
            function removeItemOption2(itemSeq) {
                ...
                for (var i = 1; i <= itemBarangJadi; i++) {
                  if (i >= itemSeq && i < itemBarangJadi) {
                    ...
                    var inp1 = sel.options[sel.selectedIndex].value;
                    var text = sel.options[sel.selectedIndex].text;
                    var inp2 = document.getElementById('jadwal_produksi_akhirdet_total'+(i+1)).value;
                    var inp3 = document.getElementById('jadwal_produksi_akhirdet_satuan'+(i+1)).value;
                    var inp4 = document.getElementById('kode_barang_jadi'+(i+1)).value;
                    var inp5 = document.getElementById('jadwal_produksi_akhirdet_keterangan'+(i+1)).value;
                    ...
                    document.getElementById('jadwal_produksi_akhirdet_total'+i).value = inp2;
                    document.getElementById('jadwal_produksi_akhirdet_satuan'+i).value = inp3;
                    document.getElementById('kode_barang_jadi'+i).value = inp4;
                    document.getElementById('jadwal_produksi_akhirdet_keterangan'+i).value = inp5;
                  };
                };
                for (var i = 1; i <= itemBarangJadi; i++) {
                  if (i==itemBarangJadi) {
                        ...
                        if (data.val2[i].estimasi_penjualandet_status == 0) {
                            $("#default-table2 tbody").append('\
                                <tr id="detailJadi'+(i+1)+'">\
                                    ...
                                    <td id="td3'+(i+1)+'">\
                                    <input type="text" class="form-control decimal" id="jadwal_produksi_akhirdet_total'+(i+1)+'" name="jadwal_produksi_akhirdet_total[]" value="'+data.val2[i].estimasi_penjualandet_jumlah+'" required/>\
                                    </td>\
                                    <td id="td4'+(i+1)+'">\
                ...
                $.ajax({
                  ...
                  success:function(data){
                    ...
                    $.ajax({
                        ...
                        data : "id="+data.val[0].t_po_customer_id.val2[0].id,
                        dataType : "json",
                        success:function(data2){
                            itemBarangJadi = data2.val2.length;
                            $("#jml_itemBarangJadi").val(itemBarangJadi);
                            
                            for(var i = 0; i < data2.val2.length; i++){
                                $("#default-table2 tbody").append('\
                                    <tr id="detailJadi'+(i+1)+'">\
                                        <td id="td0'+(i+1)+'">\
                                            '+(i+1)+'\
                                        ...
                                        <td id="td1'+(i+1)+'">\
                                            <input type="hidden" name="t_estimasi_penjualandet_id[]" value="'+data2.val2[i].po_customerdet_id+'"/>\
                                            <input type="hidden" name="barang_id[]" value="'+data2.val2[i].m_barang_id+'"/>\
                                            '+data2.val2[i].barang_kode+'\
                                        </td>\
                                        <td id="td2'+(i+1)+'">\
                                            '+data2.val2[i].barang_nama+'\
                                        </td>\
                                        <td id="td3'+(i+1)+'">\
                                        <input type="text" class="form-control decimal" id="jadwal_produksi_akhirdet_total'+(i+1)+'" name="jadwal_produksi_akhirdet_total[]" value="'+data2.val2[i].po_customerdet_qty+'" required/>\
                                        </td>\
                                        <td id="td4'+(i+1)+'">\
                                            '+data2.val2[i].satuan_nama+'\
                                        </td>\
                                        <td id="td5'+(i+1)+'">\
                                            <textarea class="form-control" rows="3" name="jadwal_produksi_akhirdet_keterangan[]" id="jadwal_produksi_akhirdet_keterangan'+(i+1)+'"></textarea>\
                                        </td>\
                ...
                $.ajax({
                  ...
                  success:function(data){
                    for(var i=0; i<data.val.length;i++){
                      ...
                      document.getElementById("sales_order").disabled = true;
                      ...
                      {
                        document.getElementsByName("jadwal_produksi_periode")[0].disabled = false;
                    ...
                    for(var i = 0; i < data.val2.length; i++){
                        if(parseInt(document.getElementsByName('jadwal_produksi_status')[0].value) < 2)
                        {
                            $("#default-table tbody").append('\
                                <tr id="detail'+(i+1)+'">\
                                    <td id="td0'+(i+1)+'">'+(i+1)+'</td>\
                                    <td id="td1'+(i+1)+'"><input type="hidden" name="jadwal_produksi_awaldet_id[]" value="'+data.val2[i].jadwal_produksi_awaldet_id+'"><input type="text" name="kode_barang[]" id="kode_barang'+(i+1)+'" value="'+data.val2[i].barang_kode+'" class="form-control num" required readonly></td>\
                                    <td id="td2'+(i+1)+'" width="30%"><select name="m_barang_id[]" id="m_barang_id_'+(i+1)+'" class="form-control select2" onchange="getBarang(this)" ><option value="'+data.val2[i].m_barang_id+'" selected>'+data.val2[i].barang_nama+'</option></select></td>\
                                    <td id="td3'+(i+1)+'"><select name="jadwal_produksi_awaldet_no_seri[]" id="jadwal_produksi_awaldet_no_seri'+(i+1)+'" class="form-control" ><option value="'+data.val2[i].jadwal_produksi_awaldet_no_seri+'" selected>'+data.val2[i].jadwal_produksi_awaldet_no_seri+'</option></select></td>\
                                    <td id="td4'+(i+1)+'"><input type="text" name="jadwal_produksi_awaldet_qty[]" id="jadwal_produksi_awaldet_qty'+(i+1)+'" class="form-control" value="'+data.val2[i].jadwal_produksi_awaldet_qty+'" ></td>\
                                    ...
                                    <td id="td6'+(i+1)+'">\
                                        <button type="button" id="btnAddRow'+(i+1)+'" class="btn sbold dark" onclick="generateItemOption1()"><i class="icon-plus"></i></button>\
                        ...
                        else
                        {
                            $("#default-table tbody").append('\
                                <tr id="detail'+(i+1)+'">\
                                    <td id="td0'+(i+1)+'">'+(i+1)+'</td>\
                                    <td id="td1'+(i+1)+'"><input type="hidden" name="jadwal_produksi_awaldet_id[]" value="'+data.val2[i].jadwal_produksi_awaldet_id+'"><input type="text" name="kode_barang[]" id="kode_barang'+(i+1)+'" value="'+data.val2[i].barang_kode+'" class="form-control num" required readonly></td>\
                                    <td id="td2'+(i+1)+'" width="30%"><select name="m_barang_id[]" id="m_barang_id_'+(i+1)+'" class="form-control select2" onchange="getBarang(this)" readonly><option value="'+data.val2[i].m_barang_id+'" selectedIndex>'+data.val2[i].barang_nama+'</option></select></td>\
                    ...
                    for(var i = 0; i < data.val3.length; i++){
                        ...
                        // alert(document.getElementsByName('jadwal_produksi_status').value);
                        if(parseInt(document.getElementsByName('jadwal_produksi_status')[0].value) < 2)
                        {
                            ...
                            $("#default-table2 tbody").append('\
                                <tr id="detailJadi'+(i+1)+'">\
                                    ...
                                    <td id="td1'+(i+1)+'">\
                                        <input type="hidden" name="jadwal_produksi_akhirdet_id[]" id="jadwal_produksi_akhirdet_id'+(i+1)+'" value="'+data.val3[i].jadwal_produksi_akhirdet_id+'">\
                                    ...
                                    <td id="td3'+(i+1)+'">\
                                    <input type="text" class="form-control decimal" id="jadwal_produksi_akhirdet_total'+itemBarangJadi+'" name="jadwal_produksi_akhirdet_total[]" value="'+data.val3[i].jadwal_produksi_akhirdet_total+'" required/>\
                                    </td>\
                                    <td id="td4'+(i+1)+'">\
                                    ...
                                    <td id="td5'+(i+1)+'">\
                                        <textarea class="form-control" rows="3" name="jadwal_produksi_akhirdet_keterangan[]" id="jadwal_produksi_akhirdet_keterangan'+(i+1)+'">'+data.val3[i].jadwal_produksi_akhirdet_keterangan+'</textarea>\
                                    </td>\
                                    <td id="td6'+(i+1)+'">\
                                        '+buttonAdd+'\
                                        '+buttonRemove+'\
