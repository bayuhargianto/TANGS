                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <?php
                                                        // if($priv_add == 1)
                                                        // {
                                                            echo '<a href="'.base_url().'Produksi/Ketidaksesuaian-Spesifikasi/Form">
        ...
        <script type="text/javascript">
            ...
            function searchData() { 
                $('#default-table').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                      url: '<?php echo base_url();?>Produksi/Ketidaksesuaian-Spesifikasi/loadData/'
                    },
                    "columns": [
                      {"name": "no","orderable": false,"searchable": false,  "className": "text-center", "width": "5%"},
                      {"name": "cabang_nama"},
                      {"name": "ketidaksesuaian_spesifikasi_nomor"},
                      {"name": "perolehan_produksi_nomor"},
                      {"name": "ketidaksesuaian_spesifikasi_tanggal"},
