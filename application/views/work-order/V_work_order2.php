        ...
        <script type="text/javascript">
            ...
            function searchData() { 
                $('#default-table').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                      url: '<?php echo base_url();?>Persetujuan/Work-Order/loadData/'
                    },
                    "columns": [
            ...
            function batalkanWO(id)
            {
                swal({
                  title: "Apakah anda yakin?",
                  text: "Data WO akan dibatalkan !",
                  type: "warning",
                  ...
                  $.ajax({
                    url: '<?php echo base_url();?>Persetujuan/Work-Order/postData/4',
                    data: { kode : id },
                    type: 'POST',
                    dataType: 'json',
