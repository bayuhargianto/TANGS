                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <form action="#" id="formAdd" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Nama Toko
                                            </label>
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <select class="form-control" name="m_customer_id" id="m_customer_id"></select> </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $('#m_customer_id').css('width', '100%');
                $('#order_referensi_id').css('width', '100%');
                selectList_customer("#m_customer_id");
                    ...
                    for(var i = 0; i < data.step1.length; i++){
                        $("#default-table tbody").append('\
                            <tr id="detail'+(i+1)+'">\
                                ...
                                <td id="td3'+(i+1)+'">\
                                    <input type="text" class="form-control num2" id="orderdet_qty'+(i+1)+'" name="orderdet_qty[]" value="'+data.step1[i].penawaran_barang_qty_ditawarkan+'" required readonly/>\
                                </td>\
                                <td id="td4'+(i+1)+'">\
