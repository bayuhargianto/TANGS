        ...
        <script type="text/javascript">
            ...
            function searchData() { 
                $('#default-table').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                      url: '<?php echo base_url();?>Persetujuan/Purchase-Order/loadData/'
                    },
                    "columns": [
            ...
            function batalkanPO(id)
            {
                swal({
                  title: "Apakah anda yakin?",
                  text: "Data PO akan dibatalkan !",
                  type: "warning",
                  ...
                  $.ajax({
                    url: '<?php echo base_url();?>Persetujuan/Purchase-Order/postData/4',
                    data: { kode : id },
                    type: 'POST',
                    dataType: 'json',
